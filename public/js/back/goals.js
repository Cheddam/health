...
},{"../createStore":160,"../utils/isPlainObject":166,"../utils/mapValues":167,"../utils/pick":168,"_process":2}],165:[function(require,module,exports){
/**
...
require('../../components/goal-admin');

},{"../../components/goal-admin":170}],170:[function(require,module,exports){
'use strict';
...
var GoalEditor = React.createClass({
    displayName: 'GoalEditor',

    render: function render() {
        return React.createElement(
            'div',
            { className: 'goal goal-editor' },
            React.createElement('input', { type: 'text', value: '{this.props.points}', onBlur: this.finishEditing }),
            React.createElement('input', { type: 'text', value: '{this.props.name}', onBlur: this.finishEditing })
        );
    }
});

var GoalViewer = React.createClass({
    displayName: 'GoalViewer',
...
var Goal = React.createClass({
    ...
    render: function render() {
        comp = this.props.editing ? React.createElement(GoalEditor, { id: this.props.id, points: this.props.points, name: this.props.name }) : React.createElement(GoalViewer, { id: this.props.id, points: this.props.points, name: this.props.name });
...
var GoalList = React.createClass({
    ...
    goals: function goals() {
        return this.props.goals.map(function () {
            return React.createElement(Goal, { key: this.props.id, id: this.props.id, editing: isGoalCurrentlyEditable(this.prop.id) });
        });
    },
    render: function render() {
        React.createElement(
...
var EditGoalInterface = React.createClass({
    displayName: 'EditGoalInterface',

    render: function render() {
        return React.createElement(
            'div',
            { className: 'edit-goal-interface' },
            React.createElement(CategoryList, { categories: store.getState().categories }),
            React.createElement(GoalList, { goals: store.getState().goals })
        );
    }
});
